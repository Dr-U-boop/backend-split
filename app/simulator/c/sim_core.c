...
int run_simulation_model(
    ...
    double y[32] = {0.0};
    for (int i = 0; i < n; i++) y[i] = init_state[i];
    ...
    for (int i = 0; i < steps; i++) {
        ...
        if (model_type == MODEL_SIBR) rk4_step_sibr(y, n, t, dt, patient, scenario, tms);
        else rk4_step_dm(y, n, t, dt, scenario, tms);
